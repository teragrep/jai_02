...
public class CachingKeyStoreAccessTest {
    ...
    public static void prepare() throws KeyStoreException, IOException {
        cksa = new CachingKeyStoreAccess(new KeyStoreAccess(new KeyStoreFactory(keyStorePath, keyStorePassword.toCharArray()).build(), keyStorePath, keyStorePassword.toCharArray()));
